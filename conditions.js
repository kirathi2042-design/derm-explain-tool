...
const conditionTemplates = [
  ...
  item("pityriasis_rosea", "慢性發炎性皮膚病", "玫瑰糠疹", { id: "pitiriasis rosea", en: "pityriasis rosea", vi: "vảy phấn hồng", th: "ผื่นกุหลาบ", ja: "ジベルばら色粃糠疹", ko: "장미색 비강진" }, causes.inflammation, treatmentKinds.antiInflammatory, { severity: "常見自限性皮疹", tags: ["玫瑰糠疹", "橢圓紅疹", "脫屑", "癢", "自限性"], typicalFollowUp: "多數 6 到 8 週會逐漸改善，若症狀明顯或超過預期請回診。", explain: commonExplain({ id: "pitiriasis rosea", en: "pityriasis rosea", vi: "vảy phấn hồng", th: "ผื่นกุหลาบ", ja: "ジベルばら色粃糠疹", ko: "장미색 비강진" }, { id: "reaksi peradangan kulit yang biasanya membaik sendiri dalam beberapa minggu", en: "a skin inflammation that usually improves on its own over several weeks", vi: "phản ứng viêm da thường tự cải thiện trong vài tuần", th: "การอักเสบของผิวหนังที่มักค่อย ๆ ดีขึ้นเองในหลายสัปดาห์", ja: "数週間で自然に改善することが多い皮膚の炎症", ko: "대개 몇 주에 걸쳐 저절로 좋아지는 피부 염증" }), treat: commonTreat({ id: "obat untuk mengurangi gatal bila perlu; sebagian besar kasus tidak perlu pengobatan kuat", en: "medicine to reduce itching if needed; most cases do not need strong treatment", vi: "thuốc giảm ngứa khi cần; đa số không cần điều trị mạnh", th: "ยาลดคันเมื่อจำเป็น ส่วนใหญ่ไม่ต้องใช้การรักษาแรง", ja: "必要に応じたかゆみ止めで、多くは強い治療を必要としません", ko: "필요 시 가려움 조절 약을 사용하며 대부분 강한 치료는 필요하지 않습니다" }), care: commonCare({ id: "Hindari mandi air terlalu panas, gunakan sabun lembut, dan jangan menggaruk kuat.", en: "Avoid very hot showers, use gentle soap, and do not scratch hard.", vi: "Tránh tắm nước quá nóng, dùng xà phòng dịu nhẹ và không gãi mạnh.", th: "หลีกเลี่ยงการอาบน้ำร้อนจัด ใช้สบู่อ่อนโยน และอย่าเกาแรง", ja: "熱すぎる入浴を避け、低刺激の石けんを使い、強くかかないでください。", ko: "너무 뜨거운 샤워를 피하고 순한 비누를 사용하며 세게 긁지 마세요." }), warn: commonWarn({ id: "Kontrol lebih awal bila ruam sangat nyeri, bernanah, cepat meluas, atau tidak membaik setelah sekitar 8 minggu.", en: "Come back earlier if the rash is very painful, has pus, spreads quickly, or does not improve after about 8 weeks.", vi: "Tái khám sớm nếu ban rất đau, có mủ, lan nhanh hoặc không cải thiện sau khoảng 8 tuần.", th: "กลับมาตรวจก่อนนัดถ้าผื่นปวดมาก มีหนอง ลามเร็ว หรือไม่ดีขึ้นหลังประมาณ 8 สัปดาห์", ja: "強い痛み、膿、急な広がり、または約8週間たっても改善しない場合は早めに受診してください。", ko: "발진이 매우 아프거나 고름이 나거나 빠르게 퍼지거나 약 8주 후에도 좋아지지 않으면 더 일찍 내원하세요." }), follow: commonFollow({ id: "Biasanya membaik bertahap dalam 6 sampai 8 minggu.", en: "It usually improves gradually within 6 to 8 weeks.", vi: "Thường cải thiện dần trong 6 đến 8 tuần.", th: "มักค่อย ๆ ดีขึ้นภายใน 6 ถึง 8 สัปดาห์", ja: "通常6から8週間で少しずつ改善します。", ko: "보통 6-8주 안에 서서히 좋아집니다." }), zhCause: "一種常見的發炎性皮疹，常先出現一塊較大的紅斑，之後身體出現多個橢圓、帶細屑的紅疹", zhTreat: "大多數玫瑰糠疹會自己慢慢好，治療以減少搔癢與不舒服為主，必要時使用止癢藥或外用藥。", zhCare: "請避免熱水燙洗、用力搓洗或抓破皮膚，洗澡和保濕請使用溫和產品。", zhWarn: "如果疹子很痛、化膿、快速擴大，或約 8 週後仍沒有改善，請提早回診。", zhFollow: "多數會在 6 到 8 週內逐漸改善，少數人可能拖得更久。" }),
  ...
  item("alopecia_areata", "頭皮與掉髮", "圓形禿", { id: "alopecia areata", en: "alopecia areata", vi: "rụng tóc từng mảng", th: "ผมร่วงเป็นหย่อม", ja: "円形脱毛症", ko: "원형탈모" }, causes.hair, treatmentKinds.antiInflammatory, {
  ...
  item("androgenetic_alopecia", "頭皮與掉髮", "雄性禿", { id: "androgenetic alopecia", en: "androgenetic hair loss", vi: "rụng tóc kiểu nội tiết", th: "ผมบางจากฮอร์โมน", ja: "男性型・女性型脱毛症", ko: "안드로겐성 탈모" }, causes.hair, treatmentKinds.observe, {
