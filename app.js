...
const treatmentPhrase = {
  id: {
    ...
    follow: { "3": "Silakan kontrol kembali dalam 3 hari.", "5": "Silakan kontrol kembali dalam 5 hari.", "7": "Silakan kontrol kembali dalam 7 hari." }
  },
  en: {
    ...
    follow: { "3": "Please return for follow-up in 3 days.", "5": "Please return for follow-up in 5 days.", "7": "Please return for follow-up in 7 days." }
  },
  vi: {
    ...
    follow: { "3": "Vui lòng tái khám sau 3 ngày.", "5": "Vui lòng tái khám sau 5 ngày.", "7": "Vui lòng tái khám sau 7 ngày." }
  },
  th: {
    ...
    follow: { "3": "กรุณากลับมาตรวจใน 3 วัน", "5": "กรุณากลับมาตรวจใน 5 วัน", "7": "กรุณากลับมาตรวจใน 7 วัน" }
  },
  ja: {
    ...
    follow: { "3": "3日後に再診してください。", "5": "5日後に再診してください。", "7": "7日後に再診してください。" }
  },
  ko: {
    ...
    follow: { "3": "3일 후 다시 내원해 주세요.", "5": "5일 후 다시 내원해 주세요.", "7": "7일 후 다시 내원해 주세요." }
  },
  zh: {
    ...
    follow: { "3": "請三天後回診。", "5": "請五天後回診。", "7": "請七天後回診。" }
  }
};
