...
const treatmentPhrase = {
  id: {
    oral: { qd: "Bila ada obat minum, minum 1 kali sehari.", bid: "Bila ada obat minum, minum 2 kali sehari.", tid: "Bila ada obat minum, minum 3 kali sehari.", qid: "Bila ada obat minum, minum 4 kali sehari." },
    ...
    follow: { "3": "Silakan kontrol kembali dalam 3 hari.", "5": "Silakan kontrol kembali dalam 5 hari.", "7": "Silakan kontrol kembali dalam 7 hari.", after_meds: "Silakan kontrol kembali setelah obat oles habis.", prn: "Setelah ini dapat diamati dahulu. Bila terasa tidak nyaman atau gejala memburuk, silakan kontrol kembali." }
  },
  en: {
    oral: { qd: "If oral medicine is prescribed, take it once a day.", bid: "If oral medicine is prescribed, take it twice a day.", tid: "If oral medicine is prescribed, take it three times a day.", qid: "If oral medicine is prescribed, take it four times a day." },
    ...
    follow: { "3": "Please return for follow-up in 3 days.", "5": "Please return for follow-up in 5 days.", "7": "Please return for follow-up in 7 days.", after_meds: "Please return for follow-up after you finish the ointment.", prn: "For now, you may observe the condition. If you feel uncomfortable or the symptoms get worse, please come back." }
  },
  vi: {
    oral: { qd: "Nếu có thuốc uống, uống mỗi ngày 1 lần.", bid: "Nếu có thuốc uống, uống mỗi ngày 2 lần.", tid: "Nếu có thuốc uống, uống mỗi ngày 3 lần.", qid: "Nếu có thuốc uống, uống mỗi ngày 4 lần." },
    ...
    follow: { "3": "Vui lòng tái khám sau 3 ngày.", "5": "Vui lòng tái khám sau 5 ngày.", "7": "Vui lòng tái khám sau 7 ngày.", after_meds: "Vui lòng tái khám sau khi dùng hết thuốc bôi.", prn: "Sau đó có thể theo dõi thêm. Nếu khó chịu hoặc triệu chứng nặng hơn, vui lòng tái khám." }
  },
  th: {
    oral: { qd: "ถ้ามียากิน ให้กินวันละ 1 ครั้ง", bid: "ถ้ามียากิน ให้กินวันละ 2 ครั้ง", tid: "ถ้ามียากิน ให้กินวันละ 3 ครั้ง", qid: "ถ้ามียากิน ให้กินวันละ 4 ครั้ง" },
    ...
    follow: { "3": "กรุณากลับมาตรวจใน 3 วัน", "5": "กรุณากลับมาตรวจใน 5 วัน", "7": "กรุณากลับมาตรวจใน 7 วัน", after_meds: "กรุณากลับมาตรวจหลังใช้ยาทาหมด", prn: "หลังจากนี้ให้สังเกตอาการก่อนได้ หากไม่สบายหรืออาการแย่ลง กรุณากลับมาตรวจ" }
  },
  ja: {
    oral: { qd: "内服薬がある場合は、1日1回服用してください。", bid: "内服薬がある場合は、1日2回服用してください。", tid: "内服薬がある場合は、1日3回服用してください。", qid: "内服薬がある場合は、1日4回服用してください。" },
    ...
    follow: { "3": "3日後に再診してください。", "5": "5日後に再診してください。", "7": "7日後に再診してください。", after_meds: "塗り薬を使い終わったら再診してください。", prn: "しばらく様子を見てもかまいません。つらい症状や悪化があれば再診してください。" }
  },
  ko: {
    oral: { qd: "먹는 약이 있으면 하루 1번 복용하세요.", bid: "먹는 약이 있으면 하루 2번 복용하세요.", tid: "먹는 약이 있으면 하루 3번 복용하세요.", qid: "먹는 약이 있으면 하루 4번 복용하세요." },
    ...
    follow: { "3": "3일 후 다시 내원해 주세요.", "5": "5일 후 다시 내원해 주세요.", "7": "7일 후 다시 내원해 주세요.", after_meds: "바르는 약을 다 사용한 뒤 다시 내원해 주세요.", prn: "이후에는 우선 경과를 관찰하셔도 됩니다. 불편하거나 증상이 악화되면 다시 내원해 주세요." }
  },
  zh: {
    oral: { qd: "如果有口服藥，請一天一次服用。", bid: "如果有口服藥，請一天兩次服用。", tid: "如果有口服藥，請一天三次服用。", qid: "如果有口服藥，請一天四次服用。" },
    ...
    follow: { "3": "請三天後回診。", "5": "請五天後回診。", "7": "請七天後回診。", after_meds: "請用完藥膏後再回診。", prn: "之後可以先觀察；如果不舒服或症狀變嚴重，請再回診。" }
  }
};
